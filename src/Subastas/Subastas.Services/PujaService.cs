...
namespace Subastas.Services
{
    public class PujaService(IPujaRepository pujaRepository) : IPujaService
    {
        ...
        public async Task<IEnumerable<Puja>> GetAllByPredicateAsync(Expression<Func<Puja, bool>> predicate)
        {
            return await pujaRepository.GetCollectionByPredicate(predicate);
        }
    }
}
